%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Deedy MultiLatex - One Page Two Column Gray Scale Resume
% LaTeX Template
% Version 1.4 (29/7/2023)
%
% Original author:
...
%
% v1.4 repository:
% https://github.com/multitexlab/Deedy-Resume-MultiLatex
%
% IMPORTANT: THIS TEMPLATE NEEDS TO BE COMPILED WITH XeLaTeX, LuaLatex OR pdfLaTeX
%
